<?php
    ...
    $posts = $APL->getPostsByTagList(['Painting']);

    // prepare photoswipe dom
?>
    
<?php
    echo '<a href="#" id="gogogo" >MATCH ME</a>';
?>
...
<script>
    ...
    function addOnClickPhotoswipe() {
        ...
        var tmp = document.getElementById('gogogo');
        tmp.onclick = createPhotoswipeFunction(0,pswpElement);
    }
